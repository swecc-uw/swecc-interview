...
const DayColumn = styled.div`
  display: grid;
  grid-template-rows: repeat(auto-fill, minmax(30px, 1fr)); /* Each time slot takes 1 fraction of the available space */
`;
...
const TimeSelector: React.FC<TimeSelectorProps> = ({
  ...
  const toggleAvailability = (dayIndex: number, hourIndex: number) => {
    ...
    updatedAvailability[dayIndex][hourIndex] = !updatedAvailability[dayIndex][hourIndex];
